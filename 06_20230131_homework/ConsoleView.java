...
public class ConsoleView {
    ...
    public static void view() {
        if (step++ == 0) {
            ...
            System.out.print(AnsiColors.ANSI_BLUE +
                    String.join("", Collections.nCopies(30, formatDiv(" "))) + "Blue Team" + AnsiColors.ANSI_RESET);
            System.out.println(AnsiColors.ANSI_GREEN +
                    String.join("", Collections.nCopies(80, formatDiv(" "))) + "Green Team" + AnsiColors.ANSI_RESET);
        } else {
    ...
    private static String PrintInfo(int npcIndex) {
        ...
        int index = HeroTeam.whiteSide.indexOf(HeroTeam.orderByYWhiteSide.get(npcIndex));
        ...
        index = HeroTeam.darkSide.indexOf(HeroTeam.getOrderByYDarkSide.get(npcIndex));
